      ...
      <div className="mw_1140 mx-auto px_12">
        <Row>
          {Categorydata.map((Category) => {
            return (
              <Col lg={3} md={4} sm={6}>
                <div className="d-flex category_card flex-column px-3 pb-3 mb-3 mt-2">
                  ...
                  <img
                    ...
                    alt="categoryimg"
                  />
                  <h5 className="text-start ff_josefin fs_md fw-semibold">
                    Bonorum Malorum
                  </h5>
                  <div className="d-flex align-items-center justify-content-between">
                    <p className="ff_josefin dark_grey fw-">$33,915</p>
        ...
        <div className="d-flex pt-2 justify-content-center align-items-center">
          <button className="ff_josefin fw-semibold fs_sm text-white text-center mt-4 bg-black rounded-5 hw_view">View more</button>
        </div>
      </div>
    </>
  );
